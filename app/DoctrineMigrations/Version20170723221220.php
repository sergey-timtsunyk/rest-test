 ...
 */
class Version20170723221220 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE `oauth2_access_tokens` (
              ...
              KEY `IDX_D247A21BD161B81F` (`clitnt_id`),
              KEY `IDX_D247A21BA76ED395` (`user_id`),
              CONSTRAINT `FK_D247A21BA76ED395` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
              CONSTRAINT `FK_D247A21BD161B81F` FOREIGN KEY (`clitnt_id`) REFERENCES `oauth2_clients` (`id`)
